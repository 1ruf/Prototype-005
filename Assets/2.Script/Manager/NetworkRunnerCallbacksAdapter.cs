...
/// <summary>
/// No-op Fusion callback adapter for services that only need a subset of runner callbacks.
/// </summary>
public abstract class NetworkRunnerCallbacksAdapter : INetworkRunnerCallbacks
{
